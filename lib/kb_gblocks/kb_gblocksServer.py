...
async_run_methods = {}
async_check_methods = {}
async_run_methods['kb_gblocks.run_Gblocks_async'] = ['kb_gblocks', 'run_Gblocks']
async_check_methods['kb_gblocks.run_Gblocks_check'] = ['kb_gblocks', 'run_Gblocks']
sync_methods['kb_gblocks.run_Gblocks'] = True
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_gblocks.run_Gblocks,
                             ...
                             types=[dict])
        self.method_authentication['kb_gblocks.run_Gblocks'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "kb_gblocks but no authentication header was passed"
                            raise err
