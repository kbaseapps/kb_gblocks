...
function kb_gblocks(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_Gblocks = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_gblocks.run_Gblocks",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_gblocks.status",
